            ...
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ $total_product }} Products</h3>
                </div>
              </div>
              <div class="col-3">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ $total_order }} Orders</h3>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ $total_user }} Users</h3>
                </div>
              </div>
              <div class="col-3">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ $total_delivered }} Delivered</h3>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success ">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ $total_processing }} Processing</h3>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success ">
