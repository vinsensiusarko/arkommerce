                                ...
                                @elseif (auth::user()->usertype == 1)
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            ...
                                            <form id="redirect-form" action="{{ route('redirect') }}" method="GET"
                                                class="d-none">
                                            </form>
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/product/{{ $product->image }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex">
                    @if ($product->discount_price != null)
                        <h3 class="font-weight-semi-bold mb-4 mr-2">${{ $product->discount_price }}</h3>
                        <h6 class="font-weight-semi-bold mb-4 text-muted"><del>${{ $product->price }}</del></h6>
                    @else
                ...
                <form action="{{ url('add_cart', $product->id) }}" method="POST">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="number" class="form-control bg-secondary text-center" name="quantity"
                                value="1" min="1">
                            <div class="input-group-btn">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="media mb-4">
                                    <img src="/home/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                        style="width: 45px;">
